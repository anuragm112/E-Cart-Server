"use strict";(self.webpackChunkserver=self.webpackChunkserver||[]).push([[1739],{38566:(xt,k,n)=>{n.d(k,{c:()=>B});var t=n(74081),_=n(72450),L=n(93415),f=n(84366),x=n(10701),F=n(32370);const S=(0,_.ZP)(L.x)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
...
`,N=(0,_.ZP)(L.x)`
  ...
  width: 100%;
  border: none;
`,B=({children:y,icon:J,...z})=>(0,t.jsxs)("div",{children:[(0,t.jsx)(f.i,{}),(0,t.jsx)(N,{as:"button",background:"primary100",padding:5,...z,children:(0,t.jsxs)(x.k,{children:[(0,t.jsx)(S,{"aria-hidden":!0,background:"primary200",children:J}),(0,t.jsx)(L.x,{paddingLeft:3,children:(0,t.jsx)(F.Z,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:y})})]})})]})},71739:(xt,k,n)=>{n.r(k),n.d(k,{default:()=>zt});var t=n(74081),_=n(10701),L=n(50703),f=n(93415),x=n(32370),F=n(70774),S=n(38101),N=n(93153),B=n(50086),y=n(48102),J=n(38566),z=n(4987),Et=n(27875),yt=n(74758),c=n(87006),Ct=n(95066),U=n(36938),rt=n(26784),Mt=n(78665),Dt=n(91561),Pt=n(31440),Tt=n(59082),jt=n(76827),P=n(98934),Ot=n(10131),at=n(6078),lt=n(51943),$=n(61020),G=n(51447),W=n(27279),o=n(70627),d=n(30469),E=n(72450),wt=n(364),Vt=n(99732),Xt=n(43433),Ht=n(83287),Jt=n(6699),Gt=n(12665),Yt=n(8175),qt=n(47853),te=n(63799),ee=n(84921),ne=n(59461),oe=n(79146),se=n(29206),ie=n(88702),re=n(81465),ae=n(51527),le=n(49204),de=n(74919),ce=n(8243);const dt=E.ZP.tr`
  &.component-row,
  &.dynamiczone-row {
    position: relative;
